...
%Question 2...Store initial elements (from above) in the vector coe0 ( no L, G, H because they are constant and hence a0, e0 and i0 is constant):
coe2 = [l0 g0 h0];
%Question 1...Store initial elements (from above) in the vector coe0 ( no L, G, H, g, h because they are constant):
...
% equation of motions (eq 16 and 19 from report) 
l = f(1);
L=f(2);
ldot=1/(L^3);
Ldot=0;
