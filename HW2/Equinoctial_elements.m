...
%...Use ODE45 to integrate the Gauss variational equations for Equi elem (eq 8-13 from AE 502 HW 2 Report)  from t0 to tf:
t0 = 0;
tf = 2*days;
...
q = f(5);
L = f(6);
%(eq 8-13 from AE 502 HW 2 Report) :
B=sqrt(1-h^2-k^2);
...
% Orbital element rates at time t (eq 8-13 from AE 502 HW 2 Report) :
